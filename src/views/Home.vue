    ...
    <el-row v-for="(project, index) in orderProjects" :key="project.id" style="padding: 10px;">
        <el-card>
            <a :href="project.url" target="_blank">
                <div class="cover" :style="'background-image: url(' + project.cover + ')'"></div>
            </a>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                order: ['bookmark', 'tuanwei', 'enroll', 'ash', 'console', 'pwhub', 'we-cv', 'mall', 'danmu', 'laravel-streamer', 'sync', 'moodrain', 'rium', 'db', 'mform', 'vocabulary', 'miao', 'wallpaper', 'pixiv-tool'],
                techColor: {
                    PHP: '',
                    Laravel: 'info',
                    NodeJs: 'success',
                ...
                projects: [{
                    ...
                    detail: '提供简单的在线 json 转 sql 语句服务，同时生成 javaBean 打包下载。',
                    ...
                    detail: '重构 GDPU 校团委官网后台，与校相关部门进行沟通，获取权限账号，利用假期时间完成。兼容远古 PHP5.3 版本，重构之前的前端代码和数据，重写后台，并上线运行。',
                    ...
                    detail: '大一的校内比赛的参赛作品，在线选择模板制作简历，与部门 3 个小伙伴共同完成。',
                    ...
                    id: 'pixiv-tool',
                    name: 'pixiv-tool | P 站工具',
                    cover: 'cover/pixiv-tool.png',
                    ...
                    detail: 'PHP 工具库，可通过 Composer 安装，附带 JSON 配置、Curl 封装、FTP 客户端等工具。',
                    ...
                    id: 'rium',
                    name: 'Rium | Rium JS 工具库',
                    cover: 'cover/rium.png',
                    detail: 'JS 工具库，可以方便使用 AJAX、表单提交、查询 URL 参数等功能',
                    ...
                    name: 'Ash | Ash 脚手架',
                    cover: 'cover/ash.png',
                    detail: '项目脚手架，包含 Laravel/Vue/Element-UI/Rium，内置 论坛 和 文件管理器 的示例',
                    url: 'https://github.com/moodrain/ash',
                    techs: ['Laravel', 'Vue'],
                }, {
                    id: 'console',
                    name: 'Console | 控制台',
                    cover: 'cover/console.png',
                    detail: '采用 Ash 脚手架，用于简单的 项目管理、部署、日志、存储，也能管理阿里云的 OSS、CDN、域名解析，和微信小程序的订阅消息模板',
                    url: 'https://github.com/moodrain/console',
                    techs: ['Laravel', 'Vue'],
                }, {
                    id: 'pwhub',
                    name: 'Pasword Hub | 密码工具',
                    cover: 'cover/pwhub.png',
                    detail: '采用 Ash 脚手架，用于存储不重要的应用账号密码，方便多设备快速使用',
                    url: 'https://github.com/moodrain/pwhub',
                    techs: ['Laravel', 'Vue'],
        ...
        methods: {
            menuSelect(index) {
                switch (index) {
                    case 'email':
                        window.open('mailto: moerain@qq.com', '_blank');
                        break
                    case 'github':
